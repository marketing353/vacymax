    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-md bg-[#0F1014] border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
            >
                {/* Header */}
                <div className="bg-[#18181b] p-6 border-b border-white/5">
                    ...
                    <p className="text-sm text-slate-400 mt-2">
                        {mode === 'signin'
                            ? 'Sign in to access your saved vacation plans'
                            : 'Create an account to save and manage your vacation plans'}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 bg-lime-accent text-dark-900 font-bold text-lg rounded-xl hover:scale-[1.02] transition-all shadow-[0_0_20px_rgba(132,204,22,0.3)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#0F1014] px-2 text-slate-500">Or continue with</span>
                        </div>
                    </div>
                        ...
                        {mode === 'signin' ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="text-lime-accent hover:underline font-bold"
                                >
                                    Sign up
                                </button>
                            </>
