    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 text-xs bg-white dark:bg-dark-surface hover:bg-rose-50 dark:hover:bg-dark-200 border border-rose-100 dark:border-dark-border px-3 py-1.5 rounded-lg text-gray-500 dark:text-gray-400 transition-all hover:scale-105 active:scale-95 shadow-sm"
            >
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute right-0 top-full mt-2 bg-white dark:bg-dark-surface border border-rose-100 dark:border-dark-border rounded-xl shadow-xl p-3 z-50 min-w-[200px] animate-fade-up">
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-3 font-medium">Share your results</p>
                        <div className="space-y-2">
                            <button
                                onClick={handleTwitterShare}
                                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-200 transition-colors text-left"
                            >
            ...
            <div className="space-y-4">
                    <div className="flex items-center justify-between px-2 animate-enter delay-400">
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 text-xs border px-3 py-1.5 rounded-lg transition-all shadow-sm ${
                                    isSaved
                                        ...
                                        : 'bg-white dark:bg-dark-surface hover:bg-lavender-50 dark:hover:bg-dark-200 border-lavender-100 dark:border-dark-border text-lavender-accent hover:scale-105 active:scale-95'
                                }`}
                            >
                                {isSaved ? (
                                    <>
                        ...
                        <button
                            ...
                            className="text-xs bg-white dark:bg-dark-surface hover:bg-rose-50 dark:hover:bg-dark-200 border border-rose-100 dark:border-dark-border px-3 py-1.5 rounded-lg text-gray-500 dark:text-gray-400 transition-all hover:scale-105 active:scale-95 shadow-sm"
                        >
                            Download .ICS
                        </button>
                    </div>
