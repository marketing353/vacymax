  ...
  return (
    <div className="min-h-[100dvh] flex flex-col text-gray-800 pb-12 overflow-x-hidden bg-light-100 relative transition-colors duration-300">
      ...
      <nav className="w-full py-3 md:py-6 px-3 sm:px-4 md:px-12 safe-px z-[60] fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b border-rose-100 transition-all duration-300 safe-pt shadow-sm">
        <div className="w-full max-w-screen-lg lg:max-w-screen-xl mx-auto flex items-center justify-between gap-2 md:gap-3">
          <div className="flex items-center gap-2 cursor-pointer group min-w-0" onClick={handleReset}>
            ...
            <span className="font-display font-bold text-base sm:text-lg md:text-xl bg-gradient-to-r from-rose-accent to-peach-accent bg-clip-text text-transparent truncate">DoubleMyHolidays</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-6 min-w-0">
            ...
            <button
              ...
              className="px-3.5 py-2 sm:px-4 md:px-6 md:py-2.5 text-xs sm:text-sm font-bold bg-gradient-to-r from-rose-accent to-peach-accent hover:shadow-lg hover:shadow-rose-accent/30 text-white rounded-full transition-all active:scale-95 transform hover:-translate-y-0.5 whitespace-nowrap flex-shrink-0"
            >
              {step > 0 ? 'Resume ✨' : 'Plan 💖'}
            </button>
          </div>
